        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/50 bg-input text-foreground"
                  required
                />
              </div>
              <div>
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            <div className="mt-6 p-4 bg-accent/10 rounded-lg border border-accent/20">
              ...
              <p className="text-sm mb-3 text-accent-foreground/80">
                Si eres médico, enfermera u otro profesional de salud, contáctanos para conocer nuestras soluciones para equipos clínicos.
              </p>
              <Button variant="outline" className="text-accent border-accent/50 hover:bg-accent/20 hover:text-accent-foreground">
